...
function Login(props) {
    ...
    return (
        <form className={` login_form ${props.theme}`} onSubmit={handleSubmit}>
            <div className=" mb-4">
                <h2>Sign in</h2>
            </div>
            <div className=" pass_div mb-3" style={{ fontSize: '1.65rem' }} >
            ...
            <div className="mb-3" style={{ fontSize: '1.65rem' }}>
